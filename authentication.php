    ...
    <nav class="navbar navbar-default navbar-fixed-top navbar-inverse" role="navigation">
      <div class="container">
        ...
        <div class="navbar-header">
          <a  class="navbar-brand headerFont text-lg"><strong>E-MATDAAN</strong></a>
        </div>
        ...
        <div class="collapse navbar-collapse" id="example-nav-collapse">
          ...
          <a href="index.html" class="btn btn-success navbar-right navbar-btn"><span class="normalFont"><strong>Home</strong></span></a>
        </div>
        ...
        <div class="col-sm-4 text-center" style="border:2px solid gray;padding:50px;">
          <?php
                      ...
                      else
                      {
                        ...
                        $sql= "SELECT * FROM evoting.tbl_admin WHERE admin_username='".$admin_username."' AND admin_password='".$admin_password."'";
